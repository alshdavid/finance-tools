...
import * as eventStream from '../event-stream/index.ts'
import { History, HistoryEvent } from '../history/index.ts'
import { RouteMap } from '../route-map/index.ts';
import { Location } from '../locator/index.ts'
import { handlerFunc, RouterEventType, RouterEvent } from './types.ts'
